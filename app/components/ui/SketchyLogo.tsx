...
interface SketchyLogoProps extends Omit<SvgIconProps, 'component'> {
    size?: number;
}

const SketchyLogo: React.FC<SketchyLogoProps> = ({size = 65, ...props}) => {
    ...
    return (
        ...
        >
            <svg
                ...
                width="508.30606pt"
                height="519.54718pt"
                viewBox="0 0 508.30606 519.54718"
                ...
                <g
                    transform="matrix(0.1,0,0,-0.1,-194.12534,711.7265)"
